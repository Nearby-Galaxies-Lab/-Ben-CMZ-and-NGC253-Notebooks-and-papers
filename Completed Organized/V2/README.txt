...
The files are labelled in alphanumeric order, and include the A and B prefixes for the appendix items that will go in my paper.

###

Steps are broken into data reduction (reprojection), dendrogram calculation, dendrogram analysis, and plotting, labelled 1,2,3,4 respectively. Results are saved to the directory of the ipynb files and a subdirectory called /results files
